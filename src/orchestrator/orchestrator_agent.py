"""
Azure OpenAI orchestrator agent using the agent_framework SDK.

Provides a ChatAgent with access to summary and key information tools.
"""
...
async def get_azure_agent() -> ChatAgent:
    """Create a ChatAgent backed by Azure OpenAI with document tools."""
    return ChatAgent(
